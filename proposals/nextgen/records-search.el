;;; records-search.el --- code for handling record indexes.

;; $Id: records-search.el,v 1.1 2001/05/13 02:08:18 burtonator Exp $
...
(defun records-search-forward (regexp)
  ...
  (interactive "Enter search string: ")
...
(defun records-search-backward (regexp)
  ...
  (interactive
   (list
    (read-string "Enter search string: ")))
